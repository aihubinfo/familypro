...
## 5.1) Writing & Localization Policy
- 当用户要求输出多语言博客内容时，默认顺序为：先中文版本，再其他语言版本。
- 中文版本不是生硬翻译稿，必须重写为适合中文读者的自然表达，保证顺畅、明确、可直接发布。
- 其他语言版本同样禁止逐句直译；应基于原文事实与意图进行意译，使用目标语言读者更自然的说法。
- 各语言版本必须保持事实、结论、产品信息、SEO 主关键词与 CTA 一致；允许在句式、举例、段落节奏上做本地化调整。
- 禁止明显 AI 腔：避免空话套话、机械排比、过度整齐的段落结构、重复性总结、夸张但无信息量的形容。
- 优先使用具体、克制、有人味的表达；像熟悉该主题的作者在写作，而不是在“生成内容”。
- 若源文质量一般，可在不改变核心事实的前提下主动润色重组，不必受原句结构束缚。
- 若原文存在不适合目标语言文化语境的比喻、双关或案例，应替换为语义等效、读者更易接受的本地表达。
